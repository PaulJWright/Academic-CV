...
{Rm~614, Kelvin Building \hfill Work: +44 (0)7491 707344 \\
University of Glasgow \hfill{LinkedIn: \href{https://www.linkedin.com/in/pauljwright91/}{in/pauljwright91}} \\ 
Glasgow, G12 8QQ \hfill{Email: paul@pauljwright.co.uk} \\ 
United Kingdom \hfill{Publication List: \href{https://ui.adsabs.harvard.edu/#search/q=orcid\%3A0000-0001-9021-611X&sort=date+desc}{NASA Astrophysics Data System}}}
...
the temperature distribution of the solar atmosphere (an ill-posed inverse problem). These techniques were used on a wide range of spectroscopic and narrowband data, including images from remote sensing instruments such as the {\it Solar Dynamics Observatory} ({\it SDO}/AIA) which provides $\sim0.7$ Tb data per day. Attended and presented at a wide range of conferences (11 oral presentations; 4 invited), including an invited workshop talk on accelerating temperature inversion with neural networks. Extensive experience with technical writing, outreach and public engagement, and passionate about data visualisation.
...
\item[] Ph.D.
        \href{}
             {Physics} \hfill {(expected April 2019)}
        %\begin{innerlist}
...
\item[] MPhys
        ...
        \begin{innerlist}
        		\item[] Year abroad at Harvard University/Smithsonian Astrophysical Observatory
...
\begin{innerlist}
    ...
    \begin{innerlist}
    	...
    	\item{} Extracted signatures of heating in the solar atmosphere using techniques including time-lag analysis (cross-correlation); Fourier analysis; wavelet analysis; and local intermittency measure (LIM).
...
\textbf{Researcher},
            \href{http://www.frontierdevelopmentlab.org/}{NASA Frontier Development Lab}
            \hfill {2018}
\begin{innerlist}
    ...
    \begin{innerlist}
  	...
  	\item{} Predicted SSI with median absolute relative uncertainties of $< 1.6\%$ using a CNN augmented with a Multi-Layer Perceptron (MLP), saving $\$20$~M on a new instrument.
  	%\item{} from four years of observations (0.7Tb per day?), in order 
...
\begin{innerlist}
    ...
    \begin{innerlist}
    	\item{} Explored the possibility of incorporating temperature maps (our data product) in to the \href{www.helioviewer.org}{Helioviewer} project, and their usefulness as a scientific tool.
    \end{innerlist}
...
\begin{innerlist}
\item[] An invited mentor of the first module of the Data Science specialisation offered by Johns Hopkins University. %Mentors are invited based on academic performance and by the support provided to fellow learners in the course forums.
\end{innerlist}
\end{innerlist}
\halfblankline
...
\section{Technical Skills:} {\it Computing:} IDL (5+ years), Python (3+ years), PyTorch, R, Bash, $\LaTeX$, PyCharm, git (GitHub, Gitlab), Microsoft Office, Adobe Creative Cloud, Linux/Unix, Mac OSX, Microsoft Windows.
