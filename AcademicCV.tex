...
\begin{innerlist}
    ...
    \begin{innerlist}
    	\item[] Designed and implemented a sophisticated stellar flare detection routine for long-cadence (30 mins) {\it Kepler} data. {\it Publications are currently in preparation}.
    \end{innerlist}
...
\begin{bibenum}
	...
	\item{} Wang, J., Sim{\~o}es, P.~J.~A., Jeffrey, N.~L.~S. \textit{et al} 2017. {\it Observations of Reconnection Flows in a Flare on The Solar Disk}, {\it ApJL} (in revision) %\MYhref[magenta]{...}{ApJL}, \MYhref[blue]{...}{xxx, xxx}
