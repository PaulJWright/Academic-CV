...
\begin{innerlist}
\item[] An invited mentor of a course in the Data Science specialization offered by Johns Hopkins University. %Mentors are invited based on academic performance and by the support provided to fellow learners in the course forums.
\end{innerlist}
\end{innerlist}
\halfblankline
