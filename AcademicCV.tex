...
\begin{innerlist}
    ...
    \begin{innerlist}
  	\item{} Using the EBTEL hydrodynamics code to model light curves from coronal loops. The parameter space of these simulations will be constrained by observations obtained during the {\it NuSTAR} heliophysics campaign, and these simulations will used to test a variety of analysis techniques.
    \end{innerlist}
...
{Using Coursera.org, a massive open online course (MOOC) platform, to take specialisation (a series of related courses and a final capstone project) offered by accredited universities to further develop skills and understanding in a wide range of computer science topics.} \\
...
\begin{innerlist}
    ...
    \begin{innerlist}
    	\item[] Four-course (plus capstone) specialisation providing riguourous training in R.
    \end{innerlist}
...
\section{Technical Skills:} {\it Computing:} IDL, Python, R, Bash, $\LaTeX$, IRAF, git, GitHub, Microsoft Office, Adobe Creative Cloud, Linux/Unix, Mac OSX, Microsoft Windows, 

\halfblankline

{\it General:} Data Analysis, Data Visualisation, Interdisciplinary Collaboration, Public Speaking, Statistics, Teaching, Writing (Technical \& Lay)
