...
\begin{innerlist}
    ...
    \begin{innerlist}
    	...
    	\item{} Studied the temperature distribution of the solar atmosphere through the recovery of an ill-posed inverse problem (the differential emission measure, DEM) using techniques such as Tikhonov Regularization, Markov-Chain Monte Carlo, and Sparsity.
...
{Using Coursera.org, a massive open online course (MOOC) platform, to take specializations (a series of related courses and a final capstone project) offered by accredited universities to further develop skills and understanding in a wide range of computer science applications.} \\
